  ...
  return (
    <FarmerSearchBarWrapper>
      ...
      <div className="relative">
        ...
        <input onChange={(e) => handleChange(e.target.value) } type="search" id="default-search" className="block p-4 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500" placeholder="Name, City" />
